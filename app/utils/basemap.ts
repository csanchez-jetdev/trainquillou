...
import type { AllPaintProperties, ExpressionSpecification, Map } from 'maplibre-gl'
import workerUrl from 'maplibre-gl/dist/maplibre-gl-worker.mjs?worker&url'

// `import.meta.url` does not survive bundling: hand maplibre the emitted worker chunk.
...
export const FRENCH_LABELS: ExpressionSpecification = ['coalesce', ['get', 'name:fr'], ['get', 'name:latin'], ['get', 'name']]

/** Generated by `scripts/build-rail-network.py`. */
export const RAIL_NETWORK = '/rail-network.geojson'

const TINTS: Array<{ id: string, prop: keyof AllPaintProperties, color: string }> = [
