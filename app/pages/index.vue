...
// Legacy shared links (/?origin=…) redirect to /app.
...
/** Most-searched stations, pointing at their landing pages (internal linking). */
const POPULAR = [
...
<template>
  <div class="min-h-[100dvh] bg-cream text-rail">
    <!-- Floor height and no `overflow-hidden`: the station suggestion list has to overflow
         the banner. -->
    <section class="relative flex min-h-[88dvh] w-full flex-col">
      <!-- LCP image. Variants are generated by hand and versioned — see README. -->
      <picture>
        <source
          type="image/avif"
