...
function submit() {
  ...
  emit('search', {
    ...
    destination: mode.value === 'route' ? destination.value.trim() : undefined,
    date: date.value,
...
<template>
  ...
  >
    ...
    <div class="relative">
      <label class="block text-xs font-semibold uppercase tracking-wide text-rail-soft">{{ originLabel }}</label>
      <input
        v-model="origin"
        type="text"
    ...
    <div v-if="mode === 'route'" class="relative mt-3">
      <label class="block text-xs font-semibold uppercase tracking-wide text-rail-soft">Gare d'arrivée</label>
      <input
        v-model="destination"
        type="text"
    ...
    <div class="mt-3 flex gap-2">
      ...
      <div v-if="mode === 'route'" class="w-32">
        <label class="block text-xs font-semibold uppercase tracking-wide text-rail-soft">Correspondances</label>
        <select
          v-model="stops"
